...
// request full image
get_image:function(c){return c=c||function(){return!1},b.image&&b.$ui.find(".face-detection-image img").length?c():(b.update_status("Loading full size image",!0),a.post(meauh.ajax_url,{action:"meauh_get_image",nonce:meauh.get_image_nonce,attachment_id:b.attachment_id},function(d){d.success&&(
// set our image
b.image=new Image,
// save for later
b.images=d.data,
